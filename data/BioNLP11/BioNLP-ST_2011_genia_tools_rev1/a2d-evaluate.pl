...
my @target_theme = ('Theme-Gene_expression', 'Theme-Transcription', 'Theme-Protein_catabolism', 'Theme-Phosphorylation',
		    'Theme-Binding', 'Theme-Localization',
		    'Theme-Regulation', 'Theme-Positive_regulation', 'Theme-Negative_regulation');

my @target_cause = ('Cause-Regulation', 'Cause-Positive_regulation', 'Cause-Negative_regulation', 'Cause-Phosphorylation');

my @target_site  = ('Site-Binding', 'Site-Phosphorylation',
		    'Site-Regulation', 'Site-Positive_regulation', 'Site-Negative_regulation',
		    'CSite-Regulation', 'CSite-Positive_regulation', 'CSite-Negative_regulation');
my @target_loc   = ('AtLoc-Localization', 'ToLoc-Localization');
